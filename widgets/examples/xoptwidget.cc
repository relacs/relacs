  ...
  : QWidget()
{
  ...
  int testflag = 0;
  Opt1.addSection( "Timing", 0, OptWidget::Bold + OptWidget::TabLabel | testflag );
  ...
  Opt1.addSection( "Settings", 0,  OptWidget::Large | OptWidget::Bold |  OptWidget::Red | testflag );
  ...
  Opt1.addSection( "Analysis" ).setStyle( OptWidget::TabLabel );
  ...
  Opt1.addSection( "Save stimuli" ).setStyle( OptWidget::Bold );
