...
#ifndef _RELACS_AUDITORY_AUDITORYSEARCH_H_
#define _RELACS_AUDITORY_AUDITORYSEARCH_H_ 1
...
class AuditorySearch : public RePro, public AuditoryTraces
{
...
public:
    ...
    /*! Constructs a AuditorySearch-RePro: intialize widgets and create options. */
  AuditorySearch( void );
    /*! Deconstructs a AuditorySearch-RePro. */
  ~AuditorySearch( void );
...
#endif /* ! _RELACS_AUDITORY_AUDITORYSEARCH_H_ */
