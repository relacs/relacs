...
#ifndef _RELACS_AUDITORY_AUDITORYNEURON_H_
...
Auditoryneuron simulates the auditory transduction chain of Locusta
...
class AuditoryNeuron : public NeuronModels
{
  Q_OBJECT
...
#endif /* ! _RELACS_AUDITORY_AUDITORYNEURON_H_ */
