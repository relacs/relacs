...
DOC_PACKAGE = daq
DOC_INSTALL_SUBDIR = /daq
DOC_CFG = $(abs_builddir)/doc/daq.dox
...
if RELACS_TOP_BUILD
DOC_TAGFILES="../numerics/doc/numerics.tag=../numerics"
else
DOC_TAGFILES="$(DESTDIR)$(docdir)/numerics.tag=../numerics"
endif
