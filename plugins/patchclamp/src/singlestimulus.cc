  ...
  : RePro( "SingleStimulus", "patchclamp", "Jan Benda", "1.6", "Oct 22, 2013" )
{
  ...
  addNumber( "startfreq", "Start sweep with frequency", 1.0, 0.0, 1000000.0, 1.0, "Hz", "Hz", "%.2f" ).setActivation( "waveform", "Sweep" );
  addNumber( "endfreq", "End sweep with frequency", 100.0, 0.0, 1000000.0, 1.0, "Hz", "Hz", "%.2f" ).setActivation( "waveform", "Sweep" );
