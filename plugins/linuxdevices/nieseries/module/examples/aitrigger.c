...
#define MAXPOINTS 200
  ...
  /*
  ioctl( ai, NIDAQLOWVALUE, 0 );
  ioctl( ai, NIDAQHIGHVALUE, 0 );
  ioctl( ai, NIDAQTRIGGERMODE, 1 );
  ioctl( ai, NIDAQTRIGGERSOURCE, 0 );
  ioctl( ai, NIDAQAIANALOGTRIGGER );
  */

  ioctl( ai, NIDAQAISTART1SOURCE, 2 );
