...
AmplifierControl::AmplifierControl( void )
  : Control( "AmplifierControl", "ephys", "Jan Benda", "2.2", "Nov 20, 2014" )
{
  ...
  addNumber( "resistanceperiod", "Approximate period of pulses generated by the amplifier for resistance measurement", ResistancePeriod, 0.01, 100.0, 0.01, "s", "ms" );
...
void AmplifierControl::notify( void )
{
  ...
  ResistancePeriod = number( "resistanceperiod" );
