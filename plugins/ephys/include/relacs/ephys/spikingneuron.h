...
/*! 
\class HodgkinHuxley
\brief The Hodgkin-Huxley (1952) model
\author Jan Benda
\todo test it!
...
/*! 
\class Connor
\brief The %Connor model with A current.
\author Jan Benda
\todo test it!
...
/*! 
\class RushRinzel
\brief The Rush-Rinzel model with A current
\author Jan Benda
\todo test it!
...
/*! 
\class Awiszus
\brief The %Awiszus model with A current
\author Jan Benda
\todo verify reference, parameter values, and units
...
/*! 
\class FleidervishSI
\brief The Fleidervish model with slowly inactivating sodium current
\author Jan Benda
\todo verify reference, parameter values, and units
...
/*! 
\class TraubHH
\brief The Traub-Miles (1991) model with the HH currents I_Na, I_K, and I_l only.
\author Jan Benda
\todo verify reference, parameter values, and units
\note Not working!
...
/*! 
\class TraubMiles
\brief The soma compartment of the Traub-Miles (1991) model
\author Jan Benda
...
\brief Modification of the soma compartment Traub-Miles (1991) model
\author Jan Benda
\todo unit of calcium concentration
\todo verify reference, parameter values, and units
...
\brief Traub-Miles model with additional slowly inactivating sodium current
\author Jan Benda
\todo unit of calcium concentration
\todo verify reference, parameter values, and units
...
\brief The Wang-Buzsaki model with an additional adaptation current.
\author Jan Benda
\todo verify reference, parameter values, and units
*/
...
/*! 
\class Crook
\brief The two-compartment %Crook model with adaptation currents.
\author Jan Benda
\todo unit of calcium concentration
\todo verify reference, parameter values, and units
...
/*! 
\class WangIKNa
\brief The %Wang et al. 2003 model with a sodium activated potassium current.
\author Jan Benda
...
/*! 
\class Edman
\brief The %Edman model with a slowly inactivating sodium current.
\author Jan Benda
\todo unit of sodium concentration
\todo verify reference, parameter values, and units
*/
