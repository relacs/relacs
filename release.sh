...
# relacs version from configure.ac:
RV=$(grep AC_INIT configure.ac)
RV=${RV#*relacs, }
RELACSVERSION=${RV%)*}
...
echo "  rsync -avP -e ssh relacs-${RELACSVERSION}.tar.gz janbenda,relacs@frs.sourceforge.net:/home/frs/project/r/re/relacs/relacs/"
echo ""
