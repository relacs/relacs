...
#define BUFFERLEN       100000  // in msec
#define MAXBUFFERBLOCKS 10000  // max number each of size DATABLOCKSIZE 
...
#define IOC_STOP_SUBDEV     _IOW(RTMODULE_MAJOR, 40, int)
#define IOC_RELEASE_SUBDEV  _IOW(RTMODULE_MAJOR, 41, int)
#define IOC_TRACENAMELIST_N _IOW(RTMODULE_MAJOR, 42, int)
#define IOC_TRACENAMELIST   _IOW(RTMODULE_MAJOR, 43, int)
#define IOC_GETLOOPCNT      _IOR(RTMODULE_MAJOR, 44, int)
// => TODO long long ioctl for recordings >=  12h@50kHz
