...

{
  ...
  cerr << "    or ident-values pairs to be used to select data based on the meta data.\n";
  ...
  cerr << "    e.g. -i '3-5:cutoff=50Hz' selects all blocks with their meta data\n";
  cerr << "    matching 'cutoff=50Hz' within the next level blocks with indices 3, 4, 5\n";
